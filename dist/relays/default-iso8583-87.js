...
class DefaultIso8583_87TcpRelay extends base_tcp_relay_1.BaseTcpRelay {
    ...
    async mapFromReversalAdvice(lpsMessageId, legacyMessage) {
        ...
        if (forwardingId !== '')
            query.where(objection_1.raw(`JSON_EXTRACT(content, '$."33"') = "${forwardingId}"`));
...
exports.DefaultIso8583_87TcpRelay = DefaultIso8583_87TcpRelay;
//# sourceMappingURL=default-iso8583-87.js.map