...
import { LegacyAuthorizationRequest, LegacyAuthorizationResponse, LegacyFinancialRequest, LegacyFinancialResponse, LegacyReversalRequest, LegacyReversalResponse } from './adaptor-relay-messages';
...
export declare type LegacyMessage = {
    [k: string]: any;
};
export declare type TcpRelayServices = {
...
export declare type TcpRelayConfig = {
    lpsId: string;
    transactionExpiryWindow?: number;
    redisConnection?: ConnectionOptions;
    responseCodes?: ResponseCodes;
};
export declare type ResponseCodes = {
    approved: string;
